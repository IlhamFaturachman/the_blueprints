...
# Runner is located in setup_and_legacy/ — use explicit path to avoid path-not-found.
if ! timeout 14m ./setup_and_legacy/run_paper_5usd.sh --paper --aggressive >> logs/cron.log 2>&1; then
	exit_code=$?

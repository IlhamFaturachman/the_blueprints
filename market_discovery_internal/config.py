...
GOLDEN_WINDOW_HOURS_MAX = float(os.getenv("GOLDEN_WINDOW_HOURS_MAX", "20.0"))
...
STRATEGY_MIN_MODEL_PROB = float(os.getenv("STRATEGY_MIN_MODEL_PROB", "0.52"))
STRATEGY_MIN_EDGE = float(os.getenv("STRATEGY_MIN_EDGE", "0.05"))

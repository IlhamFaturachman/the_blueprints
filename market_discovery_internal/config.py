...
TARGET_CITIES = {
    "new york city": {"lat": 40.7128,  "lon": -74.0060,  "icao": "KJFK"}, 
    "chicago":       {"lat": 41.8781,  "lon": -87.6298,  "icao": "KORD"},
    "london":        {"lat": 51.5074,  "lon":  -0.1278,  "icao": "EGLL"},
    "hong kong":     {"lat": 22.3193,  "lon": 114.1694,  "icao": "VHHH"},
    "miami":         {"lat": 25.7617,  "lon": -80.1918,  "icao": "KMIA"},
    "toronto":       {"lat": 43.6532,  "lon": -79.3832,  "icao": "CYYZ"},
    "paris":         {"lat": 48.8566,  "lon":   2.3522,  "icao": "LFPG"},
    "seoul":         {"lat": 37.5665,  "lon": 126.9780,  "icao": "RKSI"},
    "singapore":     {"lat":  1.3521,  "lon": 103.8198,  "icao": "WSSS"},
    "shanghai":      {"lat": 31.2304,  "lon": 121.4737,  "icao": "ZSPD"},
    "beijing":       {"lat": 39.9042,  "lon": 116.4074,  "icao": "ZBAA"},
    "los angeles":   {"lat": 34.0522,  "lon": -118.2437,  "icao": "KLAX"},
    "houston":       {"lat": 29.7604,  "lon": -95.3698,  "icao": "KIAH"},
    "dallas":        {"lat": 32.7767,  "lon": -96.7970,  "icao": "KDFW"},
    "denver":        {"lat": 39.7392,  "lon": -104.9903,  "icao": "KDEN"},
    "atlanta":       {"lat": 33.7490,  "lon": -84.3880,  "icao": "KATL"},
    "seattle":       {"lat": 47.6062,  "lon": -122.3321,  "icao": "KSEA"},
    "austin":        {"lat": 30.2672,  "lon": -97.7431,  "icao": "KAUS"},
    "madrid":        {"lat": 40.4168,  "lon":  -3.7038,  "icao": "LEMD"},
    "milan":         {"lat": 45.4642,  "lon":   9.1900,  "icao": "LIMC"},
    "tel aviv":      {"lat": 32.0853,  "lon":  34.7818,  "icao": "LLBG"},
    "warsaw":        {"lat": 52.2297,  "lon":  21.0122,  "icao": "EPWA"},
    "ankara":        {"lat": 39.9334,  "lon":  32.8597,  "icao": "LTAC"},
    "taipei":        {"lat": 25.0330,  "lon": 121.5654,  "icao": "RCTP"},
    "sao paulo":     {"lat": -23.5505, "lon": -46.6333,  "icao": "SBGR"},
    "buenos aires":  {"lat": -34.6037, "lon": -58.3816,  "icao": "SAEZ"},
    "chengdu":       {"lat": 30.5728,  "lon": 104.0668,  "icao": "ZUUU"},
    "chongqing":     {"lat": 29.4316,  "lon": 106.9123,  "icao": "ZUCK"},
    "shenzhen":      {"lat": 22.5431,  "lon": 114.0579,  "icao": "ZGSZ"},
    "wuhan":         {"lat": 30.5928,  "lon": 114.3055,  "icao": "ZHHH"},
    "lucknow":       {"lat": 26.8467,  "lon":  80.9462,  "icao": "VILK"},
}
...
WS_STALE_DETECTION_MINUTES = 2 # Threshold to trigger Hybrid Fallback (aggressive polling)

...
TARGET_CITIES = {
    "new york city": {"lat": 40.7128,  "lon": -74.0060,  "icao": "KJFK", "tz": "America/New_York"}, 
    "chicago":       {"lat": 41.8781,  "lon": -87.6298,  "icao": "KORD", "tz": "America/Chicago"},
    "london":        {"lat": 51.5074,  "lon":  -0.1278,  "icao": "EGLL", "tz": "Europe/London"},
    "hong kong":     {"lat": 22.3193,  "lon": 114.1694,  "icao": "VHHH", "tz": "Asia/Hong_Kong"},
    "miami":         {"lat": 25.7617,  "lon": -80.1918,  "icao": "KMIA", "tz": "America/New_York"}, # Eastern Time
    "toronto":       {"lat": 43.6532,  "lon": -79.3832,  "icao": "CYYZ", "tz": "America/Toronto"},
    "paris":         {"lat": 48.8566,  "lon":   2.3522,  "icao": "LFPG", "tz": "Europe/Paris"},
    "seoul":         {"lat": 37.5665,  "lon": 126.9780,  "icao": "RKSI", "tz": "Asia/Seoul"},
    "singapore":     {"lat":  1.3521,  "lon": 103.8198,  "icao": "WSSS", "tz": "Asia/Singapore"},
    "shanghai":      {"lat": 31.2304,  "lon": 121.4737,  "icao": "ZSPD", "tz": "Asia/Shanghai"},
    "beijing":       {"lat": 39.9042,  "lon": 116.4074,  "icao": "ZBAA", "tz": "Asia/Shanghai"}, # Beijing uses Shanghai TZ
    "los angeles":   {"lat": 34.0522,  "lon": -118.2437,  "icao": "KLAX", "tz": "America/Los_Angeles"},
    "houston":       {"lat": 29.7604,  "lon": -95.3698,  "icao": "KIAH", "tz": "America/Chicago"}, # Central Time
    "dallas":        {"lat": 32.7767,  "lon": -96.7970,  "icao": "KDFW", "tz": "America/Chicago"},
    "denver":        {"lat": 39.7392,  "lon": -104.9903,  "icao": "KDEN", "tz": "America/Denver"},
    "atlanta":       {"lat": 33.7490,  "lon": -84.3880,  "icao": "KATL", "tz": "America/New_York"},
    "seattle":       {"lat": 47.6062,  "lon": -122.3321,  "icao": "KSEA", "tz": "America/Los_Angeles"},
    "austin":        {"lat": 30.2672,  "lon": -97.7431,  "icao": "KAUS", "tz": "America/Chicago"},
    "madrid":        {"lat": 40.4168,  "lon":  -3.7038,  "icao": "LEMD", "tz": "Europe/Madrid"},
    "milan":         {"lat": 45.4642,  "lon":   9.1900,  "icao": "LIMC", "tz": "Europe/Rome"},
    "tel aviv":      {"lat": 32.0853,  "lon":  34.7818,  "icao": "LLBG", "tz": "Asia/Jerusalem"},
    "warsaw":        {"lat": 52.2297,  "lon":  21.0122,  "icao": "EPWA", "tz": "Europe/Warsaw"},
    "ankara":        {"lat": 39.9334,  "lon":  32.8597,  "icao": "LTAC", "tz": "Europe/Istanbul"},
    "taipei":        {"lat": 25.0330,  "lon": 121.5654,  "icao": "RCTP", "tz": "Asia/Taipei"},
    "sao paulo":     {"lat": -23.5505, "lon": -46.6333,  "icao": "SBGR", "tz": "America/Sao_Paulo"},
    "buenos aires":  {"lat": -34.6037, "lon": -58.3816,  "icao": "SAEZ", "tz": "America/Argentina/Buenos_Aires"},
    "chengdu":       {"lat": 30.5728,  "lon": 104.0668,  "icao": "ZUUU", "tz": "Asia/Shanghai"},
    "chongqing":     {"lat": 29.4316,  "lon": 106.9123,  "icao": "ZUCK", "tz": "Asia/Shanghai"},
    "shenzhen":      {"lat": 22.5431,  "lon": 114.0579,  "icao": "ZGSZ", "tz": "Asia/Shanghai"},
    "wuhan":         {"lat": 30.5928,  "lon": 114.3055,  "icao": "ZHHH", "tz": "Asia/Shanghai"},
    "lucknow":       {"lat": 26.8467,  "lon":  80.9462,  "icao": "VILK", "tz": "Asia/Kolkata"},
}
